...
*Позволяет скопировать адрес репозитория с github в локальный репозиторий git* 
...
*Данная команда позволяет передать файлы из локального репозитория в удаленный репозиторий*
...
*Данная команда позволяет перенести файлы из удаленного репозитория в локальный репозиторий и одновременно делает smerge 2-х веток*
